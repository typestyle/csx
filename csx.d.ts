declare module 'csx/csx' {
	...
	export var fixedBottom: any, fixedLeft: any, fixedRight: any, fixedTop: any;

}
declare module 'csx' {
	import main = require('csx/csx');
	export = main;
}
