...
var content = React.createElement("div", null,
    ...
    React.createElement("div", null,
        React.createElement("a", { href: "https://github.com/basarat/csx/blob/gh-pages/demo/demo.tsx" }, "Source")),
    ...
    React.createElement("div", { className: "demo", style: extend(csx.centerCenter, tall) },
    ...
    React.createElement("div", { className: "demo", style: csx.horizontal },
        React.createElement("div", null, "One"),
        React.createElement("div", null, "Two"),
        React.createElement("div", null, "Three")),
    React.createElement("h3", { id: "flexible-children", class: "has-permalink" },
        "Flexible children",
    ...
    React.createElement("div", { className: "demo", style: csx.horizontal },
        ...
        React.createElement("div", { style: csx.flex }, "Beta (flex)"),
    ...
    React.createElement("div", { className: "demo", style: tallVertical },
        React.createElement("div", null, "Alpha"),
        React.createElement("div", { style: csx.flex }, "Beta (flex)"),
        React.createElement("div", null, "Gamma")),
    React.createElement("p", null,
    ...
    React.createElement("p", null,
        ...
        ", respectively:"),
    React.createElement("div", { className: "demo", style: csx.horizontal },
        React.createElement("div", { style: csx.flex3 }, "Alpha"),
        React.createElement("div", { style: csx.flex }, "Beta"),
        React.createElement("div", { style: csx.flex2 }, "Gamma")),
    React.createElement("h3", { id: "cross-axis-alignment", className: "has-permalink" },
        "Cross-axis alignment",
        React.createElement("a", { class: "permalink", title: "Permalink", href: "#cross-axis-alignment" }, "#")),
    React.createElement("p", null,
        ...
        " layout)."),
    React.createElement("div", { className: "demo", style: tallHorizontal },
    ...
    React.createElement("p", null,
        ...
        "."),
    React.createElement("div", { className: "demo", style: style(tallHorizontal, csx.center) },
        React.createElement("div", null, "Center")),
    React.createElement("div", { className: "demo", style: style(tallHorizontal, csx.start) },
        React.createElement("div", null, "start")),
    React.createElement("div", { className: "demo", style: csx.extend(tallHorizontal, csx.end) },
        React.createElement("div", null, "end")),
    React.createElement("h2", { id: "justification", class: "has-permalink" },
        "Justification",
        React.createElement("a", { class: "permalink", title: "Permalink", href: "#justification" }, "#")),
    React.createElement("p", null,
        ...
        "."),
    React.createElement("div", { className: "demo", style: csx.extend(csx.horizontal, csx.startJustified) },
        React.createElement("div", null, "start-justified"),
        React.createElement("div", null, "start-justified"),
        React.createElement("div", null, "start-justified")),
    React.createElement("div", { className: "demo", style: csx.extend(csx.horizontal, csx.centerJustified) },
        React.createElement("div", null, "center-justified"),
        React.createElement("div", null, "center-justified"),
        React.createElement("div", null, "center-justified")),
    React.createElement("div", { className: "demo", style: csx.extend(csx.horizontal, csx.endJustified) },
        React.createElement("div", null, "end-justified"),
        React.createElement("div", null, "end-justified"),
        React.createElement("div", null, "end-justified")),
    React.createElement("div", { className: "demo", style: csx.extend(csx.horizontal, csx.aroundJustified) },
        React.createElement("div", null, "around-justified"),
        React.createElement("div", null, "around-justified"),
        React.createElement("div", null, "around-justified")),
    React.createElement("div", { className: "demo", style: csx.extend(csx.horizontal, csx.betweenJustified) },
    ...
    React.createElement("div", { className: "demo", style: tallHorizontal },
        React.createElement("div", { style: csx.selfStart }, "selfStart"),
        React.createElement("div", { style: csx.selfCenter }, "selfCenter"),
        React.createElement("div", { style: csx.selfEnd }, "selfEnd"),
        React.createElement("div", { style: csx.selfStretch }, "selfStretch"),
        React.createElement("div", null, "Default is stretch")),
    React.createElement("h2", { id: "wrapping", class: "has-permalink" },
        "Wrapping",
        React.createElement("a", { class: "permalink", title: "Permalink", href: "#wrapping" }, "#")),
    React.createElement("p", null,
        "Wrapped layouts can be enabled with the ",
        React.createElement("code", null, "wrap"),
        " style."),
    React.createElement("div", { className: "demo", style: csx.extend(narrowHorizontal, csx.wrap) },
        React.createElement("div", null, "Alpha"),
